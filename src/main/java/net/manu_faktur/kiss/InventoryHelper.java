...
import net.manu_faktur.kiss.mixin.ScreenHandlerTypeAccessor;
...
public class InventoryHelper {
    ...
    public static Text sortBlock(World world, BlockPos blockPos, ServerPlayerEntity player, SortCases.SortType sortType) {
        ...
        if (inventory == null || namedScreenHandlerFactory == null) {
            return Text.translatable("net.manu_faktur.kiss.sorting.invalid");
        }
        ...
        if (syncId.isPresent()) {
            ...
            try {
                ...
                if (canSortInventory(player, screenHandler)) {
                    ...
                    return Text.translatable("net.manu_faktur.kiss.sorting.sorted");
                } else {
                    player.closeHandledScreen();
                    return Text.translatable("net.manu_faktur.kiss.sorting.notsortable");
                }
            } catch (Exception ex) {
                player.closeHandledScreen();
                return Text.translatable("net.manu_faktur.kiss.sorting.failed");
            }
        }
        return Text.translatable("net.manu_faktur.kiss.sorting.error");
    }
